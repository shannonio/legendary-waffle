...
var loadAllTheThings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var search, results, search_term, showList;
        ...
        case 2:
          ...
          showList = function showList() {
            ...
            data.filter(function (item) {
              return item.title.toLowerCase().includes(search_term) || item.url.toLowerCase().includes(search_term);
            }).forEach(function (e) {
              var li = document.createElement("li");
              li.innerHTML = "<div><img src=\"".concat(e.thumbnailUrl, "\"/> <br/> <span>").concat(e.title, "</span></div>");
  ...
  return function loadAllTheThings() {
...
/******/ });
//# sourceMappingURL=application-ce728729933f97bf1e5b.js.map